...
.adetect-hero-title {{
    font-size: clamp(2rem, 1.1rem + 3.3vw, 4rem);
    font-weight: 620;
...
@media (max-width: 768px) {{
    [data-testid="stMainBlockContainer"] {{ padding-left: 1.2rem; padding-right: 1.2rem; padding-top: 1.4rem; }}
    a[data-testid="stTopNavLink"] {{ font-size: 0.8rem; margin-right: 0.7rem !important; }}
}}
@media (max-width: 390px) {{
    .adetect-hero-title {{ font-size: 2rem; }}
